...
function Pomodoro() {
  ...
  return (
    <section className="mx-auto max-w-xl rounded-2xl border bg-card p-8 text-center shadow-sm">
      ...
      <div className="my-8 font-heading text-7xl font-semibold tabular-nums">
        {minutes}:{remainder}
      </div>
      ...
      <p className="mt-6 text-sm text-muted-foreground">
        One focused block, then a short reset. Your task list stays available in
        the sidebar.
      </p>
    </section>
  );
...
export default function FocusPage({ mode }) {
  return (
      ...
      {mode === "pomodoro" ? (
        ...
        <>
          <header>
            ...
            <h1 className="mt-2 font-heading text-3xl font-semibold">Habits</h1>
